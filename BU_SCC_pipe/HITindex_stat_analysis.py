...
if __name__ == '__main__':
    ...
    Stat_analysis_infor.add_argument('--outlierDetection', type = str, metavar='', help = 'ways to detect outlier, can be for iqr: default, none, merge, separate, can be for cooks: 4/n, 4*mean, or 1', required=False, default= '4/n')
    Stat_analysis_infor.add_argument('--outlierMethod', type = str, metavar='', help = 'method selected to detect outlier, can be cooks or iqr', required=False, default= 'cooks')
    ...
    if args.statAnalysis:
        ...
        if args.outlierDetection != 'default' and args.outlierDetection != 'none' and args.outlierDetection != 'merge' and args.outlierDetection != 'separate'and args.outlierDetection != '4/n' and args.outlierDetection != '4*mean' and args.outlierDetection != '1':
        ...
        if args.outlierMethod != 'cooks' and args.outlierMethod != 'iqr':
