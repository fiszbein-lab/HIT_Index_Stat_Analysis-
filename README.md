...
The HITindex_Stat_analysis is a pipeline to analyze downstream data generated by the HITindex pipeline. It utilizes a generalized linear regression model that has been adapted from DEXSeq to detect differential AFE and ALE usage across conditions.
